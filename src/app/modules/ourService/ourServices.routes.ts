...
router.post(
  "/",
  validationGuard(OurServiceValidation.serviceSchema),
  authGuard(["admin"]),
  OurServiceControllers.createService
);
...
router.put(
  "/:id",
  validationGuard(OurServiceValidation.serviceUpdateSchema),
  authGuard(["admin"]),
  OurServiceControllers.updateService
);

router.delete(
  "/:id",
  authGuard(["admin"]),
  OurServiceControllers.deleteService
);
