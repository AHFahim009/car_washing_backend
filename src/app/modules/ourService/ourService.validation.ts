...
export const serviceUpdateSchema = z.object({
  ...
  price: z.number().min(0, 'Price must be a positive number').optional(), // Cost of the service
  duration: z.number().int().positive('Duration must be a positive integer').optional(), // Duration of the service
